...
exports.calDistance = function (lat1,long1,lat2,long2){
    var gps1 = new GPS(lat1, long1)
    var gps2 = new GPS(lat2, long2)
    findDistance(gps1, gps2)
    return findDistance(gps1, gps2)
}
